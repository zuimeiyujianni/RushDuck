...
<div >
	<div class="wrapper">
		<div class="container">
			<h1>用户基本信息修改界面</h1>
			<form action="${pageContext.request.contextPath }/Controller/updateUserMessage" method="post">
				...
				<br></br>
				<a href="${pageContext.request.contextPath }/Controller/getPage/${user.userid }/1">返回用户主页</a>
